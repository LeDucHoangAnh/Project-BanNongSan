...
import kshop.Dto.ProductsDtoMapper;
...
public class ProductsDao extends BaseDao {
	...
	public List<ProductsDto> GetAllDataProducts() {
		...
		List<ProductsDto> listProducts = _jdbcTemplate.query(sql1, new ProductsDtoMapper());
		return listProducts;
	}
	...
	public List<ProductsDto> GetAllProductsByPaginate(int id, int start, int totalPage) {

...
import kshop.Service.User.CategoryServiceImpl;
import kshop.Service.User.PaginateServiceImpl;
...
//		_mvShare.addObject("AllProductsByID", categoryService.GetAllProductsByID(Integer.parseInt(id)));

						...
						<li class="span4">
							<div class="thumbnail">
								<a href="product_details.html" class="overlay"></a> <a
									...
									title="add to cart"><span class="icon-search"></span> Chi Tiết</a> <a href="<c:url value = "/chi-tiet-san-pham/${ item.id_product }"/>"><img
								...
								<div class="caption cntr">
									...
									<h4>
										<a class="shopBtn" href="<c:url value = "/AddCart/${ item.id_product }"/>" title="add to cart"> Thêm vào giỏ </a>
									</h4>
